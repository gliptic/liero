...
#define FILTER_X(dest, destPitch, src, srcPitch, width, height, srcSize, destSize, FUNC, ATTRIB, \
                 READER, WRITER)                                                                 \
  do {                                                                                           \
    uint8_t* dest_ = (dest);                                                                     \
    ...
    {                                                                                            \
      ...
      D = 0;                                                                                     \
      READER(E, line_);                                                                          \
      READER(F, line_ += srcSize_);                                                              \
      G = 0;                                                                                     \
      READER(H, lineB_);                                                                         \
      READER(I, lineB_ += srcSize_);                                                             \
